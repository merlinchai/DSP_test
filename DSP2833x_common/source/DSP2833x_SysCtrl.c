...
//                   CAUTION
// This function MUST be executed out of OTP/Flash. Executing it
// out of RAM will yield unpredictable results
...
// HISPCP/LOSPCP prescale register settings, normally it will be set to default values
   SysCtrlRegs.HISPCP.all = 0x0001;//reset后默认2分频
   SysCtrlRegs.LOSPCP.all = 0x0002;//reset后默认4分频
